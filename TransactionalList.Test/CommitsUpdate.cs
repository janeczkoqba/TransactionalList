...
namespace TransactionalList.Test
{
    ...
    public class CommitsUpdate
    {
        ...
        public void UpdateOne()
        {
            ...
            list.Commit();
            Assert.AreEqual(item1, list.BaseList[0]);
        ...
        public void BaseList()
        {
            ...
            var list = new ActionTransactionalList<TransactionalItem>(new List<TransactionalItem> { item1, item2}, Update);
